...
class _OutfitCompiler:
    ...
    def _compile_hosted(
        ...
        # v1/v2 remote cores share one physical berth despite different host contracts.
        slot_key = placement.host_instance_id, 'remote_core' if prototype.category == 'remote_core' else slot
