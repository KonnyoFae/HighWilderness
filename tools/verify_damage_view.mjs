...
const out = path.resolve(process.env.HW_GUN_OUT ?? "artifacts/p2b-damage-browser");
...
let browser, page;
try {
  await request("system.hello", { client_name: "p2b.browser", client_version: "1", supported_interfaces: ["gaotian.web-bridge/v1alpha1"], required_capabilities: ["tactical.realtime.gun"] });
