"""Preview or explicitly apply the finite v12 -> v13 preparation correction."""
import argparse
...
if __name__=='__main__':
    ...
    backup=args.directory/'ammunition-upgrades'/f'v12-before-{datetime.now():%Y%m%d-%H%M%S-%f}.json'
    print(json.dumps(upgrade(store,ROOT,apply=args.apply,backup_path=backup),ensure_ascii=False,indent=2))
