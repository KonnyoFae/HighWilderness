"""Legal preparation; three incoming shells destroy a full-health magazine."""
import argparse
...
if __name__ == '__main__':
    ...
    def attach(self,battle,geometry,key=None):
        ...
        if first[0]:
            first[0] = False
            for _ in range(3):collision.DamageTests().shell(battle,(-30,30),(30,30))
    ...
    server.preparation.store.create_ship(design,'instance.magazine.browser')
