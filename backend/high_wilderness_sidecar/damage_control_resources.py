...
MISSILE_RESOURCE_INTERFACE='gaotian.persistent-ship-resources/5c-v1'
MISSILE_POLICY_INTERFACE='gaotian.battle-preparation-policy/5c-v1'
IGNITION_RESOURCE_INTERFACES=(H5D_RESOURCE_INTERFACE,MISSILE_RESOURCE_INTERFACE)
IGNITION_POLICY_INTERFACES=(H5D_POLICY_INTERFACE,MISSILE_POLICY_INTERFACE)
FUEL_RESOURCE_INTERFACES=(H5C_RESOURCE_INTERFACE,*IGNITION_RESOURCE_INTERFACES)
FUEL_POLICY_INTERFACES=(H5C_POLICY_INTERFACE,*IGNITION_POLICY_INTERFACES)
